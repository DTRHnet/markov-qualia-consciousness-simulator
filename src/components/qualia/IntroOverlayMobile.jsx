    ...
    <div className="absolute inset-0 z-10 flex items-center justify-center bg-slate-950/80 backdrop-blur-sm">
      <div className="max-w-lg px-6 text-center max-h-[90vh] overflow-y-auto">
        ...
        <div className="mt-6">
          ...
          <div className="mt-2 flex items-center justify-center gap-2 flex-col sm:flex-row">
            <input
              value={code}
            ...
            <button
              ...
              className="rounded-lg border border-white/15 px-3 py-2 text-xs text-white/70 transition hover:bg-white/10 w-full sm:w-auto"
            >
              new
            </button>
          </div>
        ...
        <div className="mt-5 space-y-1.5 text-xs text-white/50">
          {isMobile ? (
            <>
              <p><b className="text-white/80">Drag Joystick</b> — move around the field</p>
              <p><b className="text-white/80">Tap Fuse</b> — merge consciousness with nearby agents</p>
              <p><b className="text-white/80">Tap Spectate</b> — watch without participating</p>
            </>
          ) : (
            <>
        ...
        <button
          ...
          className="mt-7 w-full rounded-full bg-white px-8 py-3 text-sm font-medium text-slate-900 transition hover:bg-white/90"
        >
          Enter the flow
        </button>
      </div>
